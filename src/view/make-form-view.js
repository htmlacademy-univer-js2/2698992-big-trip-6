...
function createMakeFormTemplate(state, destinations, allOffers) {
...
export default class MakeFormView extends AbstractStatefulView {
  #destinations = null;
  #offers = null;
  #onFormSubmit = null;
  ...
  constructor({
    ...
    super();
    this._setState(MakeFormView.parsePointToState(point));
  ...
  get template() {
    return createMakeFormTemplate(this._state, this.#destinations, this.#offers);
  }
  ...
  reset(point) {
    this.updateElement(
      MakeFormView.parsePointToState(point),
    );
  }
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this.#onFormSubmit?.(MakeFormView.parseStateToPoint(this._state));
  };
